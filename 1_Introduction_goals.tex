...
consumer relationships. In this relationship \glsplural{provider} will be able to reduce the amount of consumable food that
would be wasted, and \glsplural{client} may get a different consuming experience.
