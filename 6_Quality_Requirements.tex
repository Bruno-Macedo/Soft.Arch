...
\begin{figure}[H]
    ...
    \caption{Elements of the quality tree combined with the quality attributes, the priorisation for the two main
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{lXXc}
        ...
        %QA-2.3 & They don't want to wast time with loading pages & The loading time can be fixed once there is a structure that allows loading in the first place. & performance deleted \\
