...
\newglossaryentry{sequence diagram} {
...
\newglossaryentry{sketch} {
    name={Sketch},
    description={Usually a handmade drawing used to explain an idea in a easy fashion. The goal of the sketch is to 
    promote a basic overview of the project without getting into technical details. [\cite{refmisc:BNSWMP}]}
}
