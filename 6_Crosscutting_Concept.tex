...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|c|c|X|}
        ...
        We want them to have fully control of their actions either by cancelling or by resuming an action. \\
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|c|c|X|}
        ...
        \glsplural{client} to have it on his device, without having to "ask" for it.  \\
        \bottomrule
    \end{tabularx}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|c|c|X|}
        ...
        that every input is analyzed before reaching the app and the \glsplural{client} \cite{refbook:CSWT}. \\
        \bottomrule
    \end{tabularx}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|c|c|X|}
        ...
        of the app. This will be done with the third party operators \cite{refonline:wksp}. \\
        \bottomrule
    \end{tabularx}
\end{table}
